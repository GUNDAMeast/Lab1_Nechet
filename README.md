...
### Решение
Выбирается максимум и минимум из чисел a и b. Если число num находится между минимумом и максимумом, то оно входит в промежуток от a до b. Иначе оно не входит в него.
