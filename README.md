...
Решение: Из вещественного числа x вычитается число x переведённое в целое. Если вещественное число было отрицательным то минус у дробной части уничтожается.

Альтернативное решение: Используя математические функции можно реализовать метод как одну строчку.
