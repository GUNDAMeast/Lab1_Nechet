...
### Решение
Если число кратно 3 или 5 возвращается True. Если оно не кратно или кратно одновременно - возвращается False.
...
### Решение
Выбирается большее число из первого и второго, далее выбирается большее число из третьего и большего между первым и вторым.
...
### Решение
Складываются два числа. Если сумма попадает в диапазон от 10 до 19, то всегда возвращается 20.
...
### Решение
Соотносится число, введённое пользователем, с днём недели.
...
### Решение
С помощью цикла for выводятся числа через пробел от 0 до числа, введённого пользователем, включительно.
...
### Решение
С помощью цикла for выводятся числа через пробел с шагом 2 от 0 до числа, введённого пользователем, включительно.
...
### Решение
Определяется сколько цифр в числе, которое ввёл пользователь.
...
### Решение
Выводится квадрат из * соответствующего размера если число, введённое пользователем, оказалось положительным.
...
### Решение
Выводится треугольник по правому краю из * соответствующего размера если число, введённое пользователем, оказалось положительным.
...
### Решение
Выводится индекс первого вхождения числа, введённого пользователем, в массиве. Если число не входит в массив - возвращается -1.

<img width="450" height="450" alt="image" src="https://github.com/user-attachments/assets/e7c097bb-a28d-4319-8154-27856f50ebd9" />

<img width="450" height="400" alt="image" src="https://github.com/user-attachments/assets/dc4bdc06-fdf6-4685-964f-5d3b75cc90e1" />
...
### Решение
При прохождении через массив запоминается и выводится наибольшее по модулю из всех чисел.

<img width="450" height="400" alt="image" src="https://github.com/user-attachments/assets/1b1afd52-b46b-4e88-b1b5-408874ca1d45" />

<img width="450" height="450" alt="image" src="https://github.com/user-attachments/assets/b2126310-0cf3-4c88-b229-efc1bb66064f" />
...
### Решение
Создаётся новый массив в который записываются элементы первого массива до позиции, с позиции начинается второй массив, после этого добавляются оставшиеся элементы первого маиисва, если такие имеются.

<img width="550" height="850" alt="image" src="https://github.com/user-attachments/assets/770254a8-89f5-4f27-85b3-78da681031a3" />

<img width="550" height="725" alt="image" src="https://github.com/user-attachments/assets/0813a392-6c21-47b0-886e-47573edb6920" />
...
### Решение
Создаётся новый массив в который записываются элементы первого массива, но в обратном порядке.

<img width="425" height="450" alt="image" src="https://github.com/user-attachments/assets/81d0c947-7bfc-4a5e-a2e9-d8d9b2b5aa05" />
...
### Решение
Создаётся новый массив содержащий индексы всех вхождений числа, введённого пользователем. Если число не было найдено в массиве, то выводится сообщение об этом и на выходе возвращается пустой массив.

<img width="450" height="500" alt="image" src="https://github.com/user-attachments/assets/5cdf1e11-cf6a-43fc-a70c-06d7fc741955" />

<img width="450" height="500" alt="image" src="https://github.com/user-attachments/assets/43cf7ea2-a589-4e82-b8fe-fa0be1763351" />
