...
Университет компьютерных наук и технологий
						...
						Вариант нечётный
						по дисциплине «Языки программирования C#»




	Выполнил:
	Студент 2-го курса ИКНиТ
___________  Стрельников М.В., 
		   группа ИТ-15-2024
	Проверил:
	Преподаватель кафедры информационных технологий  ПГНИУ, 
________________ Ракина В.Д.
